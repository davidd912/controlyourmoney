    ...
    if (!household) {
      ...
      if (matchingHousehold) {
        ...
        return Response.json({ 
          reply: `✅ נהדר! החשבון שלך מקושר בהצלחה למשק הבית "${matchingHousehold.name}".\n\n💬 כעת תוכל לשלוח הודעות חופשיות כמו:\n• "קניתי חלב ב-8 שקלים"\n• "קיבלתי משכורת 10000"\n• "כמה הוצאתי החודש?"\n• "תמחק את הקנייה האחרונה"\n\n🚀 בואו נתחיל!`
        });
      } else {
        return Response.json({ 
          reply: `👋 שלום! נראה שאתה משתמש חדש.\n\n🔐 כדי להתחיל, עבור לאפליקציה ויצור קוד הפעלה, ואז שלח אותו לכאן.\n\n📱 הקוד תקף ל-24 שעות.`
        });
      }
    }
