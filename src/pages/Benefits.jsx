            ...
            return (
              <motion.div
                ...
                <Card className="border-0 shadow-lg overflow-hidden">
                  <CardHeader className="bg-blue-100 text-black p-6 flex flex-col space-y-1.5 border-blue-200 dark:bg-gray-700 border-b">
                    <CardTitle className="flex items-center gap-3">
                      <Icon className={`w-6 h-6 ${iconColors[category.color]}`} aria-hidden="true" />
                      <span className="text-slate-950">{category.category}</span>
                    </CardTitle>
                  </CardHeader>
